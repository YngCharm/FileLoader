...
public class Employee {
    ...
    public final String[] employees = {"Орлов", "Миронов", "Лапшин", "Архипов", "Зайцев", "Родионов", "Игнатов",
            "Трофимов", "Панин", "Астафьев"};
    ...
    public void createFileEmployee(String[] employeeList) throws IOException {
        try(FileWriter writer = new FileWriter("E:\\project java\\FileLoader\\employee.txt", false)) {
            for(int i = 0; i < 10; i++) {
                try {
